...
$acct = mysqli_query($con, "select * from accounts where customerid='$_SESSION[customerid]'");
$acctbal = mysqli_fetch_array($acct);
        ...
        <div class="container"> 
            ...
            <tbody>
                ...
                <tr class="warning">
                 ...
                 <td><?php echo number_format($acctbal['accountbalance'],2);?></td>
                </tr>
                <tr class="info">
                 <td>Branch code</td>
               ...
               <tr class="info">
                 ...
                 <td><?= $sqlq == false ? 0 : mysqli_num_rows($sqlq); ?></td>
             </tr>
               <tr class="warning">
                 <td>Unread mails</td>
