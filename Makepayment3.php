...
<body>
    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <h2 style="margin-top: 20px">Transaction Detail:</h2>
              <table width="517" height="220" border="0">
                <tr>
                  <td width="439"><h2 style="color: green;"><?php  echo "Transaction Successful..";?><br /></h2> </td>
                </tr>
              </table>
       </form>
            </div>
