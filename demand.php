...
<div id="toptabmenu">
    ...
    <div class="logmainbox" style="width: 480px;">
        <form action="ddRegDB.php" method="POST" enctype="multipart/form-data">
            <h1>Demand Draft Deposit Form</h1>
            <div class="inset">
                <table>
                    <tr>
                   ...
                   <td><label for="IFSE" class="Ltext">IFSE Code</label></td>
                    ...
                    <tr>
                   <td><label for="Date" class="Ltext">Date On Demand Draft</label></td>
                    ...
                    <tr>
                        <td><label for="checkno" class="Ltext">Demand Draft Number</label></td>
                        <td><input type="text" name="dd" id="dd" class="loginput"<?php if (($_REQUEST["mnumset1"]==1)) echo " style=\"border:thin solid red; box-shadow:1px 1px 4px 2px #F00;\"";
                                        else echo " value=\"".$_REQUEST["Mnum1"]."\""; ?> >
                        </td>
                    </tr>
                    <tr>
                        <td><label for="checkno1" class="Ltext">Re-enter Demand Draft Number</label></td>
                        <td><input type="text" name="dd1" id="dd1" class="loginput"<?php if (($_REQUEST["mnumset1"]==1)) echo " style=\"border:thin solid red; box-shadow:1px 1px 4px 2px #F00;\"";
                                        else echo " value=\"".$_REQUEST["Mnum1"]."\""; ?> ></td>
                    </tr>
                    <tr>
                        <td><label for="imagecheck" class="Ltext">Upload DD</label></td>
