...
<body>
    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <h2 style="margin-top: 20px" align="center" ><strong>COMPOSE MAIL</strong></h2>
            <br />  <br/>
             <?php if($msgsuccess == 1) echo "<h1> Message sent successfully...</h1>";
                   ...
                   {?>    
                        ...
                        <select style="width: 40%" name="sendto" id="sendto">
                        <?php
                ...
                echo "<option value='admin'>Administrator</option>";
                        ...
                        <strong>SUBJECT</strong>
                            <input style="width: 40%" name="subject" type="text" id="subject" size="50">
                        </p>
                        ...
                        <br/>
                        <p>
                            <button class="btn btn-success btn-sm" type="submit" name="sendmsg" id="sendmsg" value="SEND MESSAGE" >SEND MESSAGE</button>
                        </p>
                        <?php } ?>
       </form> 
            </div>
