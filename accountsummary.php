...
<body>
    ...
    <!-- banner -->
        ...
        <div class="container"> 
           ...
           <h2 style="margin-top: 10px" align="center">ACCOUNTS SUMMARY</h2>
             <table style="margin-top: 30px" class="table table-striped" width="616">
         ...
         <tbody>
            ...
            {
                $bal = number_format($arrow[accountbalance],2);
                echo "<tr>
                <td>ACCOUNT TYPE</td>
                <td>{$arrow['accounttype']}</td><tr>
                <tr>
                <td>NAME</td>
       ...
       <div style="margin-top: 70px; background-color: rgb(245, 241, 241); height: 200px" class="col-md-4">
