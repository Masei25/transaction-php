    ...
    else if($_POST['trpass'] == $arrpayment1['transpassword'])
    {
        ...
        $amount=$_POST['payamt'];
                ...
                if (isset($_POST['payeetype']))
                {
                    ...
                    {     mysqli_query($con,"UPDATE accounts SET accountbalance = accountbalance+$amount WHERE customerid ='".$_POST[payto]."'") or die(mysql_error ());
                    }
                }
...
<body>
    ...
    <!-- banner -->
        ...
        <h2 style="margin-top: 20px">&nbsp;Make payment to <?php if(isset($arrpayment['payeename'])) echo $arrpayment['payeename']; ?></h2>
              <table class="table" width="564" height="220" style="margin-top: 20px">
                <?php
                if(isset($passerr))
                {
                    ?>
...
<input type="hidden" name="payeetype" value="<?php echo $payeetype; ?>"  />
                ...
                <tr>
                  ...
                  <td><input style="width:80%; border: 1px solid; outline:none; border-radius:5px" name="trpass" type="password" id="trpass" size="35" /></td>
                </tr>
                <tr>
                  <td><strong>Confirm Password</strong></td>
                  <td><input style="width:80%; border: 1px solid; outline:none; border-radius:5px" name="conftrpass" type="password" id="conftrpass" size="35" /></td>
                </tr>
                <tr>
                  <td colspan="2"><div align="right">
                    <button style="margin-right: 3px" class="btn btn-success" type="submit" name="pay2" id="pay2" value="Pay">Transfer</button>
                    <button class="btn btn-danger" name="button" type="button" onclick="<?php echo "window.location.href='accountalerts.php'"; ?>" value="Cancel" alt="Pay Now" >Cancel</button>
                  </div></td>
                </tr>
              </table>
          </form>
