...
$result = mysqli_query($con, "select * from registered_payee WHERE customer_id='$_SESSION[customerid]'");
?>
...
<body>
    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <div style="margin-top: 55px" class="col-md-8"> 
            <p style="font-size:18px;">Fund Transfer menu helps you fund transfers between your different accounts as well as making a transfer to a third party. You can even make an enquiry about your transfers and view the pending transfers through this menu.</p>
       </div>
