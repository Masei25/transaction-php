...
<body>
    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <form style="margin-left: 5px;" id="form1" name="form1" method="post" action=""onsubmit="return validateForm()">
     
              <table class="table table-borderless" width="459" height="239" border="0">
                <tr>
            ...
            <?php echo $ctrow;?>                  
                ...
                <tr>
                  ...
                  <td><input style="width: 20%" name="loginid" type="text" id="loginid" size="35" readonly="readonly" value="<?php echo $_SESSION["customerid"]; ?>"/></td>
              </tr>
                <tr>
       ...
       <div style="margin-top: 50px; background-color: rgb(245, 241, 241); height: 200px" class="col-md-4">
        ...
        <li class="nav-item">
         <a class="nav-link" href="changelogpass.php">Change Login Password</a>
        </li>
        <li class="nav-item">
         <a class="nav-link" href="changetranspass.php">Change Transaction Password</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="custprofile.php">Customer Profile</a>
        </li>
