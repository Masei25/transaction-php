    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <div class="col-md-8"> 
              ...
              <h2 style="margin-top: 20px">Pay loan</h2>
              <table class="table" width="513" height="177" style="margin-top: 20px">
                <tr>
                ...
                <tr>
                  ...
                  <td><label>
                    <input class="form-control" style="width: 70%" type="text" name="pay_amt" id="pay_amt" />
                </label></td>
              </tr>
                <tr>
                  <td colspan="2"><div align="right">
                    <button class="btn btn-success" type="submit" name="pay" id="pay" value="Pay">Pay Loan</button>
                  </div></td>
                </tr>
            </table>
          </form>
