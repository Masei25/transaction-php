...
if ((isset($_REQUEST['login']))) {
    ...
    if (mysqli_num_rows($res) == 1) {
        ...
        $res = mysqli_query($con, "SELECT * FROM employees WHERE loginid='$logid' AND password='$password'");
    ...
    echo"<div class='logmainbox' style='width:450px;'><h1>$logininfo</h1></div>";
        ...
        <div align="center" class="container"> 
          ...
          <form action="login.php" method="POST">
            <h1 style="margin-top: 20px">Sign In</h1>
            <br>
            <div class="loginset">
                <p>
                    
                    <input class="form-control" style="width: 30%" type="text" name="login" class="loginput" placeholder="Username">
                </p><br>
                <p>
                    
                    <input class="form-control" style="width: 30%" type="password" name="password" class="loginput" placeholder="Password">
                </p>
            </div>
            <p class="p-container">
                <a href="login.php?error=forgetpass">Forgot password ?</a><br/>
                <button class="btn btn-info" type="submit" name="go" id="go" value="Log in" class="loginput">Login</button>
            </p>
        </form> 
