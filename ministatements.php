        ...
        <div class="container"> 
            ...
            <div class="col-md-8"> 
                ...
                if(isset($_POST[submit]))
                    {
                    ?>
           <h2 style="margin-top: 10px">Mini statements</h2>

            <form  id="form1" name="form1" method="post" action="">
              <table class="table table-striped" width="561" border="0">
                <tr>
              ...
              while(($arrvar = mysqli_fetch_array($result))&&($count <= 3 ))
              {
                                echo " <tr>
                                             <td>$count</td>
...
else
{
    ...
    <h2>Select an Account Number</h2>
            <form style="margin-left: 10px; margin-top: 50px" id="form1" name="form1" method="POST" action="">
            <div class="form-group">
              <table width="520" height="127" border="0">
                
                <tr>
                  <td valign="top"><b style="font-size: 20px">Account number</b> <br> <label for="ac_no"></label>
                    <select class="form-control" style="width: 25%" name="accno" id="accno">
                  ...
                  <button class="btn btn-warning" style="width: 35%;" type="submit" name="submit" id="submit">Select account number</button></td>
              </tr>
            </table>
        </div>
          </form>
