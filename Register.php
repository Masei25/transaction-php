...
<body>
    ...
    <div><img src="images/logo.png" id="batimg1"><img src="images/logo.png" id="batimg2"></div>
    <div id="bodycontent">

<div id="templatemo_wrapper">

    <div class="mainbox">
        <img src="images/Bank.png" width="200" height="100" style="float:left; margin:2em 2em;">
        <div id="site_title">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="Year" class="ddlist">
                                <?php $year = array("Kolkata","New York","Chicago","London");
                                for($i=0;$i<5;$i++)
