...
{
    if (mysqli_real_escape_string($_POST[newpass]) == $_POST[newpass])
    {
    ...
    <!-- banner -->
        ...
        <div class="container"> 
            ...
            <form onsubmit="return validateForm()" id="form1" name="form1" method="post" action="">
                    <table class="table" width="606" height="314" border="0">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="210"><input style="width: 40%" name="loginid" type="text" id="loginid" size="35" readonly="readonly" value="<?php echo $_SESSION[customerid]; ?>"/></td>
                        </tr>
